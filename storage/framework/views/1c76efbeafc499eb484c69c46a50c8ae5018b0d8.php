...
<head>
    <meta charset="utf-8" />
    <title><?php echo e(get_option('SiteTitle')); ?> - لوحة التحكم - <?php echo $__env->yieldContent('title'); ?></title>
...
<body class="m-page--fluid m--skin- m-content--skin-light2 m-aside-left--skin-light m-header--fixed m-header--fixed-mobile m-aside-left--enabled m-aside-left--skin-light m-aside-left--offcanvas m-footer--push m-aside--offcanvas-default">
          ...
          <div class="m-stack__item m-brand  m-brand--skin-light ">
            ...
            <div class="m-stack m-stack--ver m-stack--general">
              ...
              <div class="m-stack__item m-stack__item--middle m-brand__logo">
                ...
                <img alt="" src="<?php echo e(url('/')); ?>/assets/images/4.png" style="width: 65px" />
          ...
          <div class="m-stack__item m-stack__item--fluid m-header-head" id="m_header_nav">
              ...
              <div id="m_header_menu" class="m-header-menu m-aside-header-menu-mobile m-aside-header-menu-mobile--offcanvas  m-header-menu--skin-light m-header-menu--submenu-skin-light m-aside-header-menu-mobile--skin-light m-aside-header-menu-mobile--submenu-skin-light ">
                  ...
                  <ul class="m-menu__nav  m-menu__nav--submenu-arrow ">
                      ...
                      <li class="m-menu__item m-menu__item--submenu m-menu__item--rel m-menu__item--open-dropdown" data-menu-submenu-toggle="click" data-redirect="true" aria-haspopup="true">

                          <a href="<?php echo e(url('/')); ?>" target="_blank" class="m-menu__link">

                            <i class="m-menu__link-icon flaticon-squares-1"></i>

                            <span class="m-menu__link-text">رئيسية </span>
              ...
              <div class="m-stack__item m-topbar__nav-wrapper">
                 ...
                 <ul class="m-topbar__nav m-nav m-nav--inline">
                  ...
                  <li class="m-nav__item m-topbar__user-profile m-topbar__user-profile--img  m-dropdown m-dropdown--medium m-dropdown--arrow m-dropdown--header-bg-fill m-dropdown--align-right m-dropdown--mobile-full-width m-dropdown--skin-light" data-dropdown-toggle="click">
                    ...
                    <img src="<?php echo e(current_moderator_avatar()); ?>" class="m--img-rounded m--marginless m--img-centered" alt=""/>

                    </span>

                    <span class="m-topbar__username m--hide"><?php echo e(current_moderator()->name); ?></span>          
                          ...
                          <div class="m-dropdown__header m--align-center" style="background: #2c2e3e">
                            ...
                            <div class="m-card-user m-card-user--skin-light">
                              ...
                              <div class="m-card-user__details">
                                ...
                                <span class="m-card-user__name m--font-weight-500"><?php echo e(current_moderator()->name); ?></span>

                                <a href="" class="m-card-user__email m--font-weight-300 m-link"><?php echo e(current_moderator()->role->name); ?></a>
                            ...
                            <div class="m-dropdown__content">
                              ...
                              <ul class="m-nav m-nav--skin-light">
                               ...
                               <!--  <li class="m-nav__item">
                                  ...
                                  <a href="<?php echo e(route('admin.moderators.myProfile')); ?>" class="m-nav__link">
                                ...
                                <li class="m-nav__item">
                                  ...
                                  <a href="<?php echo e(route('admin.auth.logout')); ?>" class="btn m-btn--pill    btn-secondary m-btn m-btn--custom m-btn--label-brand m-btn--bolder">تسجيل الخروج</a>
        ...
        <div class="m-stack m-stack--flex-tablet-and-mobile m-stack--ver m-stack--desktop">
          ...
          <div class="m-stack__item m-stack__item--left m-stack__item--middle m-stack__item--last">
            ...
            <span class="m-footer__copyright">
              ...
              <?php echo e(date('Y')); ?> &copy; <a href="http://tellers.sa" target="_blank">tellers.sa</a>
  ...
  $(document).on('click','#m_topbar_notification_icon',function () {
      $.ajax({
          type: 'get', // or post?
          url: '<?php echo e(route('admin.activities.markAllRead')); ?>' , // change as needed
          success: function(json) {
              $('#activity-counter').remove();
              $('#m_topbar_notification_icon').removeAttr('id');
              $('.m-animate-shake').removeClass('m-animate-shake');
          },
