...
<div class="m-grid__item m-grid__item--fluid m-wrapper">
            ...
            <div class="mr-auto">
                ...
                <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
                    ...
                    <li class="m-nav__item">
                        ...
                        <a href="<?php echo e(url('admin/categories')); ?>" class="m-nav__link">
    ...
    <div class="m-subheader ">
		...
		<form class="m-form" method="post" action="<?php echo e(url('admin/categories/update/' . $category->id )); ?>">
			...
			<div class="m-portlet m-portlet--tabs">
			    ...
			    <div class="m-portlet__body">
                    ...
                    <div class="form-group m-form__group row">
    									...
    									<div class="col-10">
    										...
    										<input type="text" id="title" class="form-control m-input" name="title" value="<?php echo e($category->title); ?>">
                    ...
                    <div class="form-group m-form__group row">
                      ...
                      <div class="col-10">
                        ...
                        <input type="text" id="link" class="form-control m-input" name="link" value="<?php echo e($category->link); ?>">
				...
				<div class="m-portlet__foot m-portlet__foot--fit">
					...
					<div class="m-form__actions m-form__actions">
						...
						<button type="submit" class="btn btn-accent m-btn m-btn--air m-btn--custom">SaveEdits </button>
