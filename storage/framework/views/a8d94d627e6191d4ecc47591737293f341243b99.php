...
<ul class="nav navbar-nav">
  ...
  <li ><a href="<?php echo e(url('/page/'.$page->link)); ?>"><?php echo e($page->title); ?></a></li>
  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
</ul>
...
<div class="account link-inline">
    <div class="dropdown text-right">
        ...
        <ul class="dropdown-menu">
          ...
          <li><a href="<?php echo e(url('/admin')); ?>" target="_blank"><span class="icon icon-user"></span>Control Pannel</a></li>
          <?php endif; ?>
