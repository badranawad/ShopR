...
<div class="m-grid__item m-grid__item--fluid m-wrapper">
    ...
    <div class="m-subheader ">
        ...
        <div class="d-flex align-items-center">
            ...
            <div class="mr-auto">
                ...
                <h3 class="m-subheader__title m-subheader__title--separator">الشركة</h3>
                ...
                <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
                    ...
                    <li class="m-nav__item">
                        ...
                        <a href="<?php echo e(url('admin/companies')); ?>" class="m-nav__link">

                            <span class="m-nav__link-text">الشركة</span>
    ...
    <div class="m-subheader ">
		...
		<form class="m-form" method="post" action="<?php echo e(url('admin/companies/update/' . $company->id )); ?>" enctype="multipart/form-data">
			...
			<div class="m-portlet m-portlet--tabs">
			    ...
			    <div class="m-portlet__body">
                    ...
                    <div class="form-group m-form__group row">
    									...
    									<div class="col-10">
    										...
    										<input type="text" id="name" class="form-control m-input" name="name" value="<?php echo e($company->name); ?>">
                ...
                <div class="form-group m-form__group row">
									...
									<div class="col-10">
										...
										<img src="<?php echo e($company->image()); ?>" width="200" height="200" />
