...
<div class="m-grid__item m-grid__item--fluid m-wrapper">
    ...
    <div class="m-subheader ">
        ...
        <div class="d-flex align-items-center">
            ...
            <div class="mr-auto">
                ...
                <h3 class="m-subheader__title m-subheader__title--separator">الاعداد</h3>
                ...
                <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
                    ...
                    <li class="m-nav__item">
                        ...
                        <a href="<?php echo e(url('admin/settings')); ?>" class="m-nav__link">
                            ...
                            <span class="m-nav__link-text">الاعداد</span>
                    ...
                    <li class="m-nav__item">
                           ...
                           <span class="m-nav__link-text">تعديل الاعدادات</span>
    ...
    <div class="m-subheader ">
		...
		<form class="m-form" method="post" action="<?php echo e(url('admin/settings/update/' . $setting->id )); ?>" >
			...
			<div class="m-portlet m-portlet--tabs">
			    ...
			    <div class="m-portlet__body">
                    ...
                    <div class="form-group m-form__group row">
    									...
    									<div class="col-10">
    										<input type="text" id="title" class="form-control m-input" name="title" value="<?php echo e($setting->title); ?>">
    									</div>
    								</div>
                    <div class="form-group m-form__group row">
                      <label for="tower_title" class="col-2 col-form-label">رابط فيس بوك:</label>
                      <div class="col-10">
                        <input type="text" id="facebook" class="form-control m-input" name="facebook" value="<?php echo e($setting->facebook); ?>">
                      </div>
                    </div>
                     ...
                     <div class="form-group m-form__group row">
      									...
      									<div class="col-10">
      										<input type="text" id="twitter" class="form-control m-input" name="twitter" value="<?php echo e($setting->twitter); ?>">
      									</div>
      								</div>
                      ...
                      <div class="form-group m-form__group row">
        									...
        									<div class="col-10">
        										<input type="text" id="instagram" class="form-control m-input" name="instagram" value="<?php echo e($setting->instagram); ?>">
        									</div>
        								</div>
                        ...
                        <div class="form-group m-form__group row">
          									...
          									<div class="col-10">
          										<input type="text" id="linkedIn" class="form-control m-input" name="linkedIn" value="<?php echo e($setting->linkedIn); ?>">
          									</div>
          								</div>
