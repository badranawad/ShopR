...
<div class="m-grid__item m-grid__item--fluid m-wrapper">
    ...
    <div class="m-subheader ">
		...
		<form class="m-form" method="post" action="<?php echo e(url('')); ?>/admin/companies/store" enctype="multipart/form-data">
...
<?php echo $__env->make('admin.layout',['title' => 'Add a new company'], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>