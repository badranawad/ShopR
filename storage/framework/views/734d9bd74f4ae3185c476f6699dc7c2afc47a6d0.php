...
<div class="m-grid__item m-grid__item--fluid m-wrapper">
    ...
    <div class="m-subheader ">
		...
		<form class="m-form" method="post" action="<?php echo e(url('')); ?>/admin/orders/store">
			...
			<div class="m-portlet m-portlet--tabs">
			        	...
			        	<div class="tab-content prodHeadz">
			        		...
			        		<div class="tab-pane active" role="tabpanel" id="general-tb">
			        			...
			        			<div class="form-group m-form__group row">
									...
									<label for="name" class="col-2 col-form-label">اسم العميل  :</label>
              ...
              <div class="col-10">
                ...
                <input type="text" id="country" class="form-control m-input" name="country" value="<?php echo e(old('country')); ?>">
          ...
          <div class="col-10">
            ...
            <input type="text" id="city" class="form-control m-input" name="city" value="<?php echo e(old('city')); ?>">
              ...
              <div class="col-10">
                ...
                <input type="text" id="address" class="form-control m-input" name="address" value="<?php echo e(old('address')); ?>">
      ...
      <label for="phone" class="col-2 col-form-label">الجوال:</label>

      <div class="col-10">

        <input type="number" id="phone" class="form-control m-input" name="phone" value="<?php echo e(old('phone')); ?>">
				...
				<div class="m-portlet__foot m-portlet__foot--fit">
					...
					<div class="m-form__actions m-form__actions">
						...
						<button type="submit" class="btn btn-accent m-btn m-btn--air m-btn--custom">اضافة الطلب </button>
...
<?php echo $__env->make('admin.layout',['title' => 'اضافه طلب جديد'], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>