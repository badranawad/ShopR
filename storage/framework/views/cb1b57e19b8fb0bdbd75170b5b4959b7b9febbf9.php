                    ...
                    <table class="table table-hover table-responsive" width="100%" style="text-align:center;">
                        ...
                        <?php if( $products ): ?>
                            ...
                            <tr>
                                ...
                                <td><?php echo $product->status == 1 ? '<span class="m-badge m-badge--success m-badge--dot"></span>&nbsp;<span class="m--font-bold m--font-success">Active</span>' : '<span class="m-badge m-badge--danger m-badge--dot"></span>&nbsp;<span class="m--font-bold m--font-danger">InActive</span>'; ?></td>
                                <td>
