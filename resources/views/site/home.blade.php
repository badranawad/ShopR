    ...
    {{-- <div class="tp-banner">
      <ul>
        ...
        <li data-transition="fade" data-slotamount="7" data-masterspeed="2000"
          data-thumb="{{ url('/assets') }}/img/slider/slide1.jpg" data-delay="10000">
          <img width="100%" src="{{ $slider->image() }}" alt="laptopmockup_sliderdy"
            data-lazyload="{{ $slider->image() }}" data-bgposition="top" data-duration="12000"
            data-ease="Power0.easeInOut" data-bgfit="115" data-bgfitend="100" data-bgpositionend="right">


          <div class="tp-caption largeHeadingWhite sfl str tp-resizeme start" data-x="20" data-y="center"
            data-voffset="-40" data-speed="1200" data-start="950" data-easing="easeInOutExpo" data-splitin="none"
            data-splitout="none" data-elementdelay="0.1" data-endelementdelay="0.1" data-endspeed="800"
            data-endeasing="easeInOutExpo">
            <h1>{{ $slider->title }}</h1>
          </div>

          <div class="tp-caption detailTextWhiteLarge sfl tp-resizeme start" data-x="20" data-y="center"
            data-voffset="30" data-speed="1200" data-start="1350" data-easing="easeInOutExpo" data-splitin="none"
            data-splitout="none" data-elementdelay="0.1" data-endelementdelay="0.1" data-endspeed="300">
            <p>{!! $slider->description !!}</p>
          </div>

          <div class="tp-caption sfb tp-resizeme start" data-x="20" data-hoffset="0" data-y="center" data-voffset="90"
            data-speed="1200" data-start="1750" data-easing="easeInOutExpo" data-splitin="none" data-splitout="none"
            data-elementdelay="0.1" data-endelementdelay="0.1" data-endspeed="300">
            <a href="#shop-collection" class="btn btn-common"><i class="icon-handbag" style="font-size: 14px"></i>Start
              Shopping</a>
          </div>
      ...
      <div class="col-md-4 col-sm-4 col-xs-12">
        <div class="feature-item-content">
          ...
          <div class="feature-content">
            ...
            <a href="{{ url('/category/men') }}" class="btn btn-common">Shop Now</a>
          </div>
        </div>
      </div>
      <div class="col-md-4 col-sm-4 col-xs-12">
        <div class="feature-item-content">
          ...
          <div class="feature-content">
            ...
            <a href="{{ url('/category/women') }}" class="btn btn-common">Shop Now</a>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-4 col-sm-4 col-xs-12">
        <div class="feature-item-content">
          ...
          <div class="feature-content">
            ...
            <a href="{{ url('/category/kids') }}" class="btn btn-common">Shop Now</a>
          </div>
        </div>
      </div>
    </div>
              ...
              <div class="product-box">
                ...
                <div class="actions">
                  <div class="add-to-links">
                    <a href="{{ url('/cart/add/'.$product->id) }}" class="btn-cart"><i
      ...
      <div class="testimonials-carousel owl-carousel">
        <div class="item">
          <div class="testimonial-item">
            ...
            <div class="datils">
              <p>“ Lorem Ipsum is simply dummy text of the printing andypesetting industry. Lorem ipsum a simpleLorem
                <br> Ipsum has been the industry's standard dummy hic et quidem. Dignissimos ad <br> maxime velit unde
                inventore quasi vero dolorem.“</p>
            </div>
          </div>
        </div>
        <div class="item">
